...
INSERT INTO inventory_mart.fact_inventory_movement
SELECT
...
INSERT INTO inventory_mart.fact_inventory_snapshot_daily
SELECT
  snapshot_date,
  warehouse_id,
  sku_id,
...
INSERT INTO inventory_mart.fact_purchase_order_lines
SELECT
...
INSERT INTO inventory_mart.fact_sales_order_lines
SELECT
  toDate(created_at) AS created_date,
  order_id,
  so_line_id,
...
INSERT INTO inventory_mart.fact_stock_counts
SELECT
  count_date,
  warehouse_id,
  sku_id,
